        ...
        <div className='container p-3'>
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    ...
                    <div>
                        <a href='' className='mx-5' style={{textDecoration:"none"}}>Explore our products <FontAwesomeIcon icon={faArrowRightLong} /></a>
                        <a href='' style={{textDecoration:"none"}}>Try Kite <FontAwesomeIcon icon={faArrowRightLong} /></a>
